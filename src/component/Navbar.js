...
export default function Navbar(props) {
  ...
  // let changeTheme = (e) => {
  //   if (props.data.theme === 'dark') {
  //     console.log('i am dark')
  //     props.data.setTheme('light');
  //     e.target.checked = false;
  //   }
  //   else {      
  //     props.data.setTheme('dark');
  //     e.target.checked = true;
  //   }
  //   document.documentElement.setAttribute('data-bs-theme', props.data.theme);
  //   console.log(props.data.theme);
  // }=
      ...
      <div className="container-fluid" >
        ...
        <div className="d-flex align-items-center">
          ...
          <div className="form-check form-switch">
            <input className="form-check-input" type="checkbox" role="switch" id="" onClick={props.changeTheme} defaultChecked />
          </div>
